...
#Developer : Bressan, Luis
  ...
  Scenario Outline: TS:["<TS>"] - [1 / 2 Login ]  - "<Scenario>" - "<Description>"
    ...
    Then validate result "<type>" "<result>"
    Examples:
      | TS  | Scenario | Description          |HomePage                       |type |Username   | Password                    |result                          |
    ...
    Scenario Outline: TS:["<TS>"] - [ 3 checkboxes ]  - "<Scenario>" - "<Description>"
      ...
      Examples:
        ...
        | 002 |    0001  | Test checks and unchecks checkboxes.     |http://10.10.0.25:7080/checkboxes   |CKBX|true   |
        | 002 |    0001  | Test checks and unchecks checkboxes.     |http://10.10.0.25:7080/checkboxes   |CKBX|false  |
    ...
    Scenario Outline: TS:["<TS>"] - [ 4 context menu ]  - "<Scenario>" - "<Description>"
      ...
      Examples:
        | TS  | Scenario | Description                              |HomePage                              |type|status|
        | 002 |    0001  | Test right clicks on the context menu.   |http://10.10.0.25:7080/context_menu   |CON |      |
    ...
    Scenario Outline: TS:["<TS>"] - [ 6 dropdow ]  - "<Scenario>" - "<Description>"
      ...
      Examples:
        | TS  | Scenario | Description                                                  |HomePage                              |type        |
        | 002 |    0001  | test selects Option 1 and Option 2 from the drop down menu.   |http://10.10.0.25:7080/dropdown      |Option 1    |
        | 002 |    0001  | test selects Option 1 and Option 2 from the drop down menu.   |http://10.10.0.25:7080/dropdown      |Option 2    |
    ...
    Scenario Outline: TS:["<TS>"] - [ 8 dinamic content ]  - "<Scenario>" - "<Description>"
      ...
      Examples:
        ...
        | 002 |    0001  | test selects Option 1 and Option 2 from the drop down menu.   |http://10.10.0.25:7080/dynamic_content       |5    |
    ...
    Scenario Outline: TS:["<TS>"] - [ 8 dinamic content ]  - "<Scenario>" - "<Description>"
      ...
      And validate result "<type>" "<status2>"
      And Test clicks on the Enable Button
      And validate result "<type>" "<status3>"
      And Test clicks on the Disabled Button
      And validate result "<type>" "<status4>"
      Examples:
        | TS  | Scenario | Description            |HomePage                                   |type|status     |status2     |status3       |status4        |
        | 002 |    0001  | test Dynamic Controls  |http://10.10.0.25:7080/dynamic_controls    |DC  |It's gone! |It's back!  |It's enabled! |It's disabled! |
    ...
    Scenario Outline: TS:["<TS>"] - [ 9 Dynamic Loading ]  - "<Scenario>" - "<Description>"
      ...
      Examples:
        | TS  | Scenario | Description          |HomePage                                      |status           |
        | 002 |    0001  | test Dynamic Loading  |http://10.10.0.25:7080/dynamic_loading/2        |Hello World!   |
    ...
    Scenario Outline: TS:["<TS>"] - [ 10 File Download ]  - "<Scenario>" - "<Description>"
      ...
      Examples:
        | TS  | Scenario | Description          |HomePage                             |type   |status         |
        | 002 |    0001  | test File Download  |http://10.10.0.25:7080/download       |FILE   |some-file.txt  |
    ...
    Scenario Outline: TS:["<TS>"] - [ 11 File Download ]  - "<Scenario>" - "<Description>"
      ...
      Examples:
        | TS  | Scenario | Description          |HomePage                             |type    |status         |
        | 002 |    0001  | test File Upload     |http://10.10.0.25:7080/upload        |LOGIN   |some-file.txt  |
    ...
    Scenario Outline: TS:["<TS>"] - [ 12 Floating Menu ]  - "<Scenario>" - "<Description>"
      ...
      Examples:
        | TS  | Scenario | Description          |HomePage                             |type    |status      |
        | 002 |    0001  | test Floating Menu   |http://10.10.0.25:7080/floating_menu |LOGIN   |Home        |
